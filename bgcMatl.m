...
seawater.coeffThermalExpansion = 1500e-7; % [m/m/K]  Highly variable with temperature and pressure
seawater.bulkModulus = 2.34e9; % [Pa]  
...
syntacticTrelleborgEL34.coeffThermalExpansion = 0; % @@@ unknown.
syntacticTrelleborgEL34.bulkModulus = 1965e6; % [Pa] % 2018/10/17 12:31:43  Trelleborg data says 1931e6 Pa
syntacticTrelleborgEL34.density = 0.545e3; % [kg/m^3]
syntacticTrelleborgEL34.thermalConductivity = NaN;
syntacticTrelleborgEL34.specificHeat = NaN;
syntacticTrelleborgTG32.coeffThermalExpansion = 0; % @@@ unknown.
syntacticTrelleborgTG32.bulkModulus = 340000*PSI2PA; % [Pa] specified as minimum
syntacticTrelleborgTG32.density = 32*LB2KG/FT2M^3; % [kg/m^3]
syntacticTrelleborgTG32.thermalConductivity = NaN;
syntacticTrelleborgTG32.specificHeat = NaN;
...
lead.coeffThermalExpansion = 28.9e-6; % [m/m/K]
lead.bulkModulus = 46e9; % [Pa] 
lead.density = 11340; % [kg/m^3]
lead.thermalConductivity = 35.3; % [W/m/K]
lead.specificHeat = 129; % [J/kg/K]
% silicone oil: Clearco, 100 cs
siliconeoil.coeffThermalExpansion = 0.00096; % [m/m/K]
siliconeoil.bulkModulus = 158370*PSI2PA; % [Pa] 
