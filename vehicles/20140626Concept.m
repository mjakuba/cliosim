...
% Payload components, see payload list excel doc for more details
% All weights listed below are air weights
% Volumes for Modeled OEM parts approximates
% m in [kg] V in [m^3]
c = bgcInitComponent('Seabird 29 Fastcat CTD');
c.V = 0.00344776;
c.m = 2.7;
c.rho = c.m/c.V;
prm.components = bgcAddComponent(c,prm.components);

c = bgcInitComponent('Wetlabs 25 cm Transmissometer');
c.V = 0.00171347;
c.m = 3.6;
c.rho = c.m/c.V;
prm.components = bgcAddComponent(c,prm.components);

c = bgcInitComponent('Wetlabs ECO Flourometer');
c.V = 0.00026075;
c.m = 0.433;
c.rho = c.m/c.V;
prm.components = bgcAddComponent(c,prm.components);

c = bgcInitComponent('Aanderaa 4330 Optode');
c.V = 0.00006246;
c.m = 0.175;
c.rho = c.m/c.V;
prm.components = bgcAddComponent(c,prm.components);

c = bgcInitComponent('Digiquartz Transmitter');
c.V = 0.00006246;
c.m = 0.175;
c.rho = c.m/c.V;
prm.components = bgcAddComponent(c,prm.components);

c = bgcInitComponent('Valeport VA500 Altimeter');
c.V = 0.00039981;
c.m = 0.95;
c.rho = c.m/c.V;
prm.components = bgcAddComponent(c,prm.components);

c = bgcInitComponent('Transducer ITC-3013');
c.V = 0.0033708;
c.m = 1.85973;
c.rho = c.m/c.V;
prm.components = bgcAddComponent(c,prm.components);

c = bgcInitComponent('Micromodem');
c.V = 0.00043598;
c.m = 0.353802;
c.rho = c.m/c.V;
prm.components = bgcAddComponent(c,prm.components);

c = bgcInitComponent('MMF-7500');
c.V = 0.00021189;
c.m = 0.66;
c.rho = c.m/c.V;
prm.components = bgcAddComponent(c,prm.components);

c = bgcInitComponent('MMB-7500');
c.V = 0.00022902;
c.m = 0.69;
c.rho = c.m/c.V;
prm.components = bgcAddComponent(c,prm.components);

c = bgcInitComponent('iBCN');
c.V = 0.00037829;
c.m = 0.81;
c.rho = c.m/c.V;
prm.components = bgcAddComponent(c,prm.components);
